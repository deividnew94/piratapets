class CitaController < ApplicationController
  ...
  private
    ...
    def citum_params
      params.require(:citum).permit(:IdCita, :Paciente, :Duenio, :Telefono, :Direccion, :Fecha_Registro, :Vacunas, :CLIENTES_IdCliente, :CLIENTES_ADMINISTRADOR_IdAdministrador)
    end
end
