class PacientesController < ApplicationController
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:IdPacientes, :Nombre_Duenio, :Especie, :Raza, :Genero, :Tipo_Sangre, :Tamanio, :Actividad, :Peso, :Fecha_Nacimiento, :Codigo_Paciente, :CLIENTES_IdCliente, :CLIENTES_ADMINISTRADOR_IdAdministrador, :HISTORIA_IdHistoria)
    end
end
