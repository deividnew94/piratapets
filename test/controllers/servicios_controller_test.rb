...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { CATALOGO_IdCatalogo: @servicio.CATALOGO_IdCatalogo, IdServicio: @servicio.IdServicio, Nombre_Servicio: @servicio.Nombre_Servicio, Precio_Servicio: @servicio.Precio_Servicio } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { CATALOGO_IdCatalogo: @servicio.CATALOGO_IdCatalogo, IdServicio: @servicio.IdServicio, Nombre_Servicio: @servicio.Nombre_Servicio, Precio_Servicio: @servicio.Precio_Servicio } }
