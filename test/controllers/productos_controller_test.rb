...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { IdProducto: @producto.IdProducto, Nombre_Producto: @producto.Nombre_Producto, Precio_Producto: @producto.Precio_Producto } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { IdProducto: @producto.IdProducto, Nombre_Producto: @producto.Nombre_Producto, Precio_Producto: @producto.Precio_Producto } }
