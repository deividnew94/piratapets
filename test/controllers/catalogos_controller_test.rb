...
class CatalogosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalogo" do
    assert_difference('Catalogo.count') do
      post catalogos_url, params: { catalogo: { IdCatalogo: @catalogo.IdCatalogo, Productos: @catalogo.Productos, Servicios: @catalogo.Servicios } }
    end
  ...
  test "should update catalogo" do
    patch catalogo_url(@catalogo), params: { catalogo: { IdCatalogo: @catalogo.IdCatalogo, Productos: @catalogo.Productos, Servicios: @catalogo.Servicios } }
